<div class="row">
    <div class="col-md">
        <h1 class="h3 mb-4">
            <a class="ml-1 btn btn-secondary addUser" href="#" data-toggle="modal" data-target="#modalForm"><i class="fa fa-plus-circle"></i> Add</a>
            <a class="ml-1 btn btn-secondary addGenerate" href="#" data-toggle="modal" data-target="#modalGenerateForm"><i class="fa fa-users"></i> Generate</a>
            <span class="float-right mb-4">Users</span>
        </h1>
